...
function user_job_setup()
    ...
    state.Weapons:options('Heishi', 'LowBuff', 'MagicWeapons', 'ProcDagger', 'ProcSword', 'ProcGreatSword',
        'ProcScythe', 'ProcPolearm', 'ProcGreatKatana', 'ProcKatana', 'ProcClub', 'ProcStaff')
    ...
    send_command('bind !b gs c set WeaponskillMode Proc;gs c set CastingMode Proc;gs c update')
