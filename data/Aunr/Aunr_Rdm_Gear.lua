function user_job_setup()
    ...
    state.Weapons:options('None', 'Naegling', 'Sequence', 'DualWeapons', 'DualWeaponsAcc', 'DualEvisceration',
        'DualClubs', 'DualAeolian', 'DualProcDaggers', 'EnspellOnly')
    ...
    send_command('bind !b gs c set skipprocweapons true;gs c reset weaponskillmode;gs c set weapons none')
