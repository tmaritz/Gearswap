...
function init_gear_sets()
	...
	sets.precast.Waltz = {
		...
		back="Solemnity Cape",waist="Chaac Belt",legs="Dashing Subligar",feet="Valorous Greaves"}
	...
	sets.midcast.FastRecast = {
		...
		back="Solemnity Cape",waist="Klouskap Sash +1",legs="Tali'ah Sera. +2",feet="Tot. Gaiters +1"}
	...
	sets.midcast.Cure = {
		...
		back="Pastoralist's Mantle",waist="Klouskap Sash +1",legs="Tali'ah Sera. +2",feet="Tot. Gaiters +1"}
	...
	sets.idle.Refresh = {main="Izizoeksi",sub=gear.PDTMABKumbha,ammo="Staunch Tathlum",
		head="Jumalik Helm",neck="Loricate Torque +1",ear1="Sanare Earring",ear2="Genmei Earring",
		body="Jumalik Mail",hands="Macabre Gaunt. +1",ring1="Defending Ring",ring2="C. Palug Ring",
		back="Solemnity Cape",waist="Flume Belt +1",legs="Tali'ah Sera. +2",feet="Skd. Jambeaux +1"}
	...
	sets.defense.PDT = {ammo="Staunch Tathlum",
		...
		body="Jumalik Mail",hands="Macabre Gaunt. +1",ring1="Defending Ring",ring2="C. Palug Ring",
		back="Solemnity Cape",waist="Flume Belt +1",legs="Tali'ah Sera. +2",feet="Nukumi Ocreae +1"}
	...
	sets.engaged.PDT = {ammo="Staunch Tathlum",
		...
		back="Solemnity Cape",waist="Flume Belt +1",legs="Meg. Chausses +2",feet="Valorous Greaves"}
