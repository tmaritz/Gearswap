...
function init_gear_sets()
	...
	sets.precast.FC = {ammo="Impatiens",
		...
		back="Solemnity Cape",waist="Flume Belt +1",legs="Founder's Greaves",feet="Carmine Greaves +1"}
	...
	sets.midcast.FastRecast = {ammo="Staunch Tathlum",
		head="Carmine Mask +1",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
		body="Taeon Tabard",hands="Leyline Gloves",ring1="Lebeche Ring",ring2="Prolix Ring",
		back="Solemnity Cape",waist="Tempus Fugit",legs="Founder's Greaves",feet="Carmine Greaves +1"}
	...
	sets.defense.MDT = {ammo="Staunch Tathlum",
		...
		body="Tartarus Platemail",hands="Sulev. Gauntlets +2",ring1="Moonbeam Ring",ring2="Moonlight Ring",
		back="Solemnity Cape",waist="Flume Belt +1",legs="Arke Cosc. +1",feet="Amm Greaves"}
