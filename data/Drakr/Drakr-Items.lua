...
gear.taeon_pet_body = {
    name = "Taeon Tabard",
    augments = {'Pet: Accuracy+15 Pet: Rng. Acc.+15', 'Pet: "Dbl. Atk."+4', 'Pet: Damage taken -4%'}
}
gear.taeon_phalanx_body = {
    name = "Taeon Tabard",
    augments = {'Mag. Evasion+15', 'Spell interruption rate down -10%', 'Phalanx +3'}
}
...
gear.herculean_wsd_feet = {
    name = "Herculean Boots",
    augments = {'Accuracy+23 Attack+23', 'Weapon skill damage +5%', 'DEX+10', 'Accuracy+10', 'Attack+1'}
}
